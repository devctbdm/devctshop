...
export const generalSettings = pgTable("general_settings", {
  ...
  supportedCurrencies: text("supported_currencies").array().notNull().default(sql`ARRAY['USD', 'BDT']::text[]`),
  usdToBdtRate: numeric("usd_to_bdt_rate", { precision: 12, scale: 4 }).notNull().default("120.00"),
...
export const orders = pgTable(
  "orders",
  {
    ...
    baseCurrency: char("base_currency", { length: 3 }).default("USD"),
